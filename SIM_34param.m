% SIM_34param is a zero-dimensional model which calculates ice and
...
function enhancement = SIM_34param(etabr,etaagg,etaRSg,etaRSG,etaCOA,etaSH,...
    duration,step,INPstop,pmax,Fshatter,Fbr,Tminbr,FRS,factor)
