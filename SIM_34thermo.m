% SIM_34thermo is a zero-dimensional model which calculates ice and
...
function [enhancement,Nice] = SIM_34thermo(etabr,etaagg,etaRSg,etaRSG,etaCOA,etaSH,...
    duration,step,INPstop,uz,Tstart,tau)
